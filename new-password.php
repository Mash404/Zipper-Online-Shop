            ...
            <div class="col-md-4 offset-md-4 form mt-5">
                <form action="new-password.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control mb-3" type="password" name="password" placeholder="Create new password" required>
                    </div>
                    <div class="form-group">
                        <input class="form-control mb-3" type="password" name="cpassword" placeholder="Confirm your password" required>
                    </div>
                    <div class="form-group d-flex align-items-center justify-content-center">
                        <input class="rounded-pill btn btn-color slide-btn" type="submit" name="change-password" value="Change">
                    </div>
                </form>
            </div>
        </div>
